...
# durable synchronization state 0006, and task workspaces 0007.
...
assert payload["post_migration_revision"] == "20260909_0007"
...
print("[OK] Historical 0001 backup was restored, adopted to 0007 and retained the seeded audit marker")
PY
