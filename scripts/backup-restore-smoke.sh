...
# and deadline/cancellation 0004.
...
assert payload["post_migration_revision"] == "20260907_0004"
...
print("[OK] Historical 0001 backup was restored, adopted to 0004 and retained the seeded audit marker")
PY
